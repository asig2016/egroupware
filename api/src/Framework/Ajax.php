...
//				error_log(__METHOD__.__LINE__."($app):$width --> reading idotssideboxwidth");
	...
	*/
	...
	function do_sidebox()
	{
		...
		if ($md5_session[$app] !== $md5 || in_array($app, array('infolog','acilog','acemailstor','actpm','filemanager','acactivity2','acerp','acagreements','actele','aclaf','acmailprotocol','actmclients','acorders')))
		{
